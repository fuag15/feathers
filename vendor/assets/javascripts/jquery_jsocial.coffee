...
(($) ->
  $.fn.jsocial = (options) ->
    ...
    , options)
    @each ->
      target = "target=\"_blank\""  if options.newPage #if user wants link to open in new page
      $this = $(this) #cache 'this' , define variables
      total_links = 0 #used to auto set the width of ul, for centering
      list = "<ul class = \"social_links\">" #open the list element
      if options.github
        list += "<li><a href=\"http://github.com/" + options.github + "\" class=\"github\" " + target + ">Github</a></li>"
        total_links++
      if options.googleplus
        list += "<li><a href=\"http://plus.google.com/" + options.googleplus + "\" class=\"googleplus\" " + target + ">Google+</a></li>"
        total_links++
      if options.twitter
        list += "<li><a href=\"http://twitter.com/" + options.twitter + "\" class=\"twitter\" " + target + ">Twitter</a></li>"
        total_links++
      if options.facebook
        list += "<li><a href=\"http://" + options.facebook + "\" class=\"facebook\" " + target + " >Facebook</a></li>"
        total_links++
      if options.flickr
        list += "<li><a href=\"http://flickr.com/" + options.flickr + "\" class=\"flickr\" " + target + " >Flickr</a></li>"
        total_links++
      if options.friendfeed
        list += "<li><a href=\"http://friendfeed.com/" + options.friendfeed + "\" class=\"friendfeed\" " + target + " >FriendFeed</a></li>"
        total_links++
      if options.delicious
        list += "<li><a href=\"http://delicious.com/" + options.delicious + "\" class=\"delicious\" " + target + " >Delicious</a></li>"
        total_links++
      if options.digg
        list += "<li><a href=\"http://digg.com/users/" + options.digg + "\" class=\"digg\" " + target + " >Digg</a></li>"
        total_links++
      if options.lastfm
        list += "<li><a href=\"http://www.last.fm/user/" + options.lastfm + "\" class=\"lastfm\" " + target + " >Last.FM</a></li>"
        total_links++
      if options.linked
        list += "<li><a href=\"http://" + options.linked + "\" class=\"linked-in\" " + target + " >Linked-In</a></li>"
        total_links++
      if options.youtube
        list += "<li><a href=\"http://" + options.youtube + "\" class=\"youtube\" " + target + " >YouTube</a></li>"
        total_links++
      if options.feed
        list += "<li><a href=\"http://feeds.feedburner.com/" + options.feed + "\" class=\"feed\" " + target + " >Feedburner</a></li>"
        total_links++
      list += "</ul>" #close the ul
      $this.append list #add the list to the DOM
      $("ul.social_links li").css "float", "left"  if options.inline #add the float left to each list element
      #end inline if
      $(this).removeClass("social").addClass "social_small"  if options.small
      #end small icons if
